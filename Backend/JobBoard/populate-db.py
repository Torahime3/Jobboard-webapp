...
Login.objects.create(username="sophie", password=make_password("sophie123", salt="jobboard", hasher="default"), email="sophie.moreau@toulouse.com", token=get_random_string(length=50), id_people=Peoples.objects.get(pk=8))
