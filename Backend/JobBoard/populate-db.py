...
Login.objects.create(username="tristan", password=make_password("tristan123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=1).email, token=get_random_string(length=50),id_people=Peoples.objects.get(pk=1))
Login.objects.create(username="jean", password=make_password("jean123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=2).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=2))
Login.objects.create(username="pierre", password=make_password("pierre123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=3).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=3))
Login.objects.create(username="paul", password=make_password("paul123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=4).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=4))
Login.objects.create(username="jacqueslef", password=make_password("jacqueslef123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=5).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=5))
Login.objects.create(username="marie", password=make_password("marie123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=6).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=6))
Login.objects.create(username="julie", password=make_password("julie123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=7).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=7))
Login.objects.create(username="sophie", password=make_password("sophie123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=8).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=8))
Login.objects.create(username="lucie", password=make_password("lucie123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=9).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=9))
Login.objects.create(username="emma", password=make_password("emma123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=10).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=10))
Login.objects.create(username="nathan", password=make_password("nathan123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=11).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=11))
Login.objects.create(username="ariirau", password=make_password("ariirau123", salt="jobboard", hasher="default"), email=Peoples.objects.get(pk=12).email, token=get_random_string(length=50), id_people=Peoples.objects.get(pk=12))
